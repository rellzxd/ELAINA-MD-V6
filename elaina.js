...
XeonWlcm = await getBuffer(`https://api.lolhuman.xyz/api/base/welcome?apikey=${lolkey}&img1=${ppuser}&img2=${ppgroup}&background=https://telegra.ph/file/cad544088cc3dd7aab33c.png&username=${nama}&member=${memb}&groupname=${namagc}`)
XeonLft = await getBuffer(`https://api.lolhuman.xyz/api/base/leave?apikey=${lolkey}&img1=${ppuser}&img2=${ppgroup}&background=https://telegra.ph/file/cad544088cc3dd7aab33c.png&username=${nama}&member=${memb}&groupname=${namagc}`)
                if (anu.action == 'add') {
