...
const { jadibot, listJadibot } = require('./jadibot')
let { TelegraPh, UploadFileUgu, webp2mp4File } = require('./lib/uploader2')
virgamm = fs.readFileSync(`./src/virgam.jpeg`)
...
//FAKE CONTACT
const virkon = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': ngazap(prefix), 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Click to chat\nEND:VCARD`, 'jpegThumbnail': virgamm, thumbnail: thumb,sendEphemeral: true}}}
//FAKEREPLY PRODUCT
const ftoko = {
key: {
fromMe: false,
...
//FAKEREPLY VID
//DOC VIRUS
const virdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: philips,jpegThumbnail: virgamm}}}
//FAKEREPLY VID
...
if (autoreadsw) {
	...
	//auto react whatsapp message
if (XeonBotInc.autoreact) {
...
console.log("Answer: " + result.jawaban)
XeonBotInc.sendText(m.chat, `Time has run out\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, fkontak)
delete tebakgambar[m.sender.split('@')[0]]
}
} else if (args[0] === 'word') {
...
if (!q1 && !q2 && !q3) return reply(`Example : ${prefix}${command} 1|22|2023`)
	yabai = await fetchJson(`https://api.lolhuman.xyz/api/countdown/${q1}/${q2}/${q3}?apikey=${lolkey}`)
    kens = yabai.result
	 reply(`「 *COUNT DOWN* 」
*Tanggal* : ${q1}
*Bulan* : ${q2}
...
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://api.lolhuman.xyz/api/attp2?apikey=${lolkey}&text=${text}`, 'hisoka', 'morou', m, {asSticker: true})
...
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://api.lolhuman.xyz/api/attp?apikey=${lolkey}&text=${text}`, 'Xeon', 'Op', m, {asSticker: true}).catch((err) => reply(mess.error))
         }
         break
case 'ttp': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://api.lolhuman.xyz/api/ttp6?apikey=${lolkey}&text=${text}`, 'A L Y A', 'B O T M D', m, {asSticker: true})
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
axios.get(`https://rest-api-elaina.herokuapp.com/api/nsfw/cum?apikey=elaina`)
.then(({data}) => {
XeonBotInc.sendImage(m.chat, data.url, mess.success, fkontak)
})
break
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/ahegao?apikey=elaina`)
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/shota?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'ryouiki': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/ryouiki?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/kobo?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'kaela': case 'kaela-kovalskia': case 'kovalskia':
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/kaela?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'ollie': case 'kureiji-ollie': case 'kureiji':
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/ollie?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/zeta?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'things': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/thighs?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hgirls': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/gifs?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hloli': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/nsfwloli?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'twitter': 
...
tweetvid untuk mendapatkan video
tweetimg untuk mendapatkan image`)
break
case 'tweetvid':
...
reply(mess.wait)
anu = await fetchJson(`https://rest-api-elaina.herokuapp.com/api/downloader/twittervid?url=${q}&apikey=elaina`)
...
if (!q) return reply(`Where's the link?`)
reply(mess.wait)
anu = await fetchJson(`https://rest-api-elaina.herokuapp.com/api/downloader/twitterimg?url=${q}&apikey=elaina`)
res = await getBuffer(anu.result)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/milf?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'paizuri': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/pussy?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'orgy': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/orgy?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hmanga': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/manga?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'maid': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/maid?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'netorare': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/netorare?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'jahy': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/jahy?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cuckold': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/cuckold?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hass': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/ass?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'yuri': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/yuri?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'kitsune': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/hentai?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'futanari': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/futanari?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'anal': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/anal?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'tentacles': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/tentacles?apikey=elaina`)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/glasses?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'zettai': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/zettai?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'bdsm': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/bdsm?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'bj': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/bj?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'blowjob': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/blowjob?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'girlsolo': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/tits?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'foot': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/foot?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'feet': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/erofeet?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'femdom': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/femdom?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'gangbang': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/gangbang?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'lesbians': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/cum_jpg?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kemonomimi': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/kemonomimi?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kuni': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/kuni?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'boobs': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/masturbation?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'nsfwwall': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/api/morensfw/mobilewall?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'hneko': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/neko?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'sfwneko': 
if (isBan) return reply(mess.ban)	 			
...
if (!m.isGroup) return replay(mess.group)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/neko2?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'panties': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/panties?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'trap': 
if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendMessage(m.chat, anu.result, fkontak)
break
case 'purba': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
reply(mess.wait)
anu = await fetchJson(`https://api.lolhuman.xyz/api/bahasapurba?apikey=kamugay&text=${text}`)
XeonBotInc.sendMessage(m.chat, anu.result, fkontak)
break
case 'danbooru': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!text) return reply(`What do you looking for?`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/danbooru?apikey=${lolkey}&query=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'gtapass': 
if (isBan) return reply(mess.ban)	 			
...
var q1 = mon.split("|")[0]
var q2 = mon.split("|")[1]
anu = await getBuffer(`https://api.lolhuman.xyz/api/gtapassed?apikey=${lolkey}&text1=${q1}&text2=${q2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'hartatahta': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/hartatahta?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'customht': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Name ?`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/hartacustom?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'cocofun': 
if (isBan) return reply(mess.ban)	 			
...
dis = njay.dislike
views = njay.views
uploader = njay.uploader
durasi = njay.duration
gambar = await getBuffer(njay.thumbnail)
nowm = njay.nowm
wm = njay.withwm
kont = (`「 *CocoFun Downloader* 」
*Judul* : ${judul}
*Tag* : ${tag}
*Durasi* : ${durasi}
*Uploader* : ${uploader}
...
*No WM* : ${nowm}
*With WM* : ${wm}`)
XeonBotInc.sendMessage(m.chat, { image: gambar, caption: kont }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
...
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/gimage?apikey=${lolkey}&query=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'faktaunik': case 'uniquefact':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
yeyy = anu.result
XeonBotInc.sendMessage(m.chat, yeyy, fkontak)
break
case 'ssweb': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/sswebfull?apikey=${lolkey}&url=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'memekertas': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Text?`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/meme1?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'memetombol': 
if (isBan) return reply(mess.ban)	 			
...
if (!q1 && !q2) return reply(`Example : ${prefix}${command} tahu|enak`)
reply(mess.wait)
var mon = args.join(' ')
var q1 = mon.split("|")[0]
var q2 = mon.split("|")[1]
anu = await getBuffer(`https://api.lolhuman.xyz/api/meme2?apikey=${lolkey}&text1=${q1}&text2=${q2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'memeheart': 
if (isBan) return reply(mess.ban)	 			
...
if (!q1 && !q2 && !q2) return reply(`Example : ${prefix}${command} tahu|enak`)
reply(mess.wait)
var mon = args.join(' ')
var q1 = mon.split("|")[0]
var q2 = mon.split("|")[1]
var q3 = mon.split("|")[2]
anu = await getBuffer(`https://api.lolhuman.xyz/api/meme3?apikey=${lolkey}&text1=${q1}&text2=${q2}&text3=${q3}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'changemymind': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Text?`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/creator/changemymind?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: `Change My Mind` }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kannagen': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!text) return reply(`Text?`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/creator/kannagen?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'ohno': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Text?`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/creator/ohno?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'fakecommentyt': 
if (isBan) return reply(mess.ban)	 			
...
var q1 = mon.split("|")[0]
var q2 = mon.split("|")[1]
metia = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
tempelr = await TelegraPh(metia)
if (!/image/.test(mime)) return reply(`Where's the image for profile?`)
if (!q1 && !q2) return reply(`Example : ${prefix}${command} username|comment`)
anu = await getBuffer(`https://api.lolhuman.xyz/api/ytcomment?apikey=${lolkey}&username=${q1}&comment=${q2}&img=${tempelr}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'stick': 
if (isBan) return reply(mess.ban)	 			
...
var q9 = mon.split("|")[8]
var q10 = mon.split("|")[9]
var q11 = mon.split("|")[10]
var q12 = mon.split("|")[11]
var q13 = mon.split("|")[12]
var q14 = mon.split("|")[13]
var q15 = mon.split("|")[14]
metia = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
tempel2 = await TelegraPh(metia)
if (!/image/.test(mime)) return reply(`Where's the image for profile?`)
if (!q1 && !q2) return reply(`Example : ${prefix}${command} nik|provinsi|kabupaten|nama|tanggallahir|jeniskelamin|alamat|rtrw|lurah|camat|agama|nikah|kerja|warga|kadaluarsa`)
anu = await getBuffer(`https://api.lolhuman.xyz/api/ktpmaker?apikey=${lolkey}&nik=${q1}&prov=${q2}&kabu=${q3}&name=${q4}&ttl=${q5}&jk=${q6}&jl=${q7}&rtrw=${q8}&lurah=${q9}&camat=${q10}&agama=${q11}&nikah=${q12}&kerja=${q13}&warga=${q14}&until=${q15}&img=${tempel2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'facedetect': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
metia = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teim = await TelegraPh(metia)
if (!/image/.test(mime)) return reply(`Where's the image?`)
anu = await getBuffer(`https://api.lolhuman.xyz/api/facedetect?apikey=${lolkey}&img=${teim}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'genderdetect': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
metia = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
templer = await TelegraPh(metia)
if (!/image/.test(mime)) return reply(`Where's the image?`)
nek = await getBuffer(templer)
anu = await fetchJson(`https://api.lolhuman.xyz/api/genderdetect?apikey=${lolkey}&img=${templer}`)
XeonBotInc.sendMessage(m.chat, { image: nek, caption: anu.result }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'nsfwcheck': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
metia = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
templi = await TelegraPh(metia)
if (!/image/.test(mime)) return reply(`Where's the image?`)
nek = await getBuffer(templi)
anu = await fetchJson(`https://api.lolhuman.xyz/api/nsfwcheck?apikey=${lolkey}&img=${templi}`)
XeonBotInc.sendMessage(m.chat, { image: nek, caption: anu.result }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'facepalm': 
if (isBan) return reply(mess.ban)	 			
...
templi = await TelegraPh(metia)
if (!/image/.test(mime)) return reply(`Where's the image?`)
anu = await getBuffer(`https://api.lolhuman.xyz/api/creator1/facepalm?apikey=${lolkey}&img=${templi}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case '1977': 
if (isBan) return reply(mess.ban)	 			
...
if (!/image/.test(mime)) return reply(`Where's the image for profile?`)
reply(mess.wait)
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/filter/1977?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'xpro2': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/filter/xpro2?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'aden': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/filter/aden?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'brannan': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/filter/brannan?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'brooklyn': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/filter/brooklyn?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'moon': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/filter/moon?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'hitler': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/creator1/hitler?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'rounded': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/editor/roundimage?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'lofi': 
if (isBan) return reply(mess.ban)	 			
...
mets = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
teker = await TelegraPh(mets)
anu = await getBuffer(`https://api.lolhuman.xyz/api/filter/lofi?apikey=${lolkey}&img=${teker}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'qrcode': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/qrcode?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'ramadhan': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/ramadhan?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'aesthetic': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random/estetic?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'sagiri': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/sagiri?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'ayuzawa': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/ayuzawa?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kaneki': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/akira?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'sakura': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/sakura?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'satanic': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/satanic?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'emojipng': 
if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
anu = await fetchJson(`https://rest-api-elaina.herokuapp.com/api/maker/emoji2png?text=${q}&apikey=elaina`)
ya = await getBuffer(anu.result)
XeonBotInc.sendMessage(m.chat, { image: ya, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'darkpfp': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/random/darkpfp?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
...
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/meme/memeindo?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await fetchJson(`https://api.lolhuman.xyz/api/asupan?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { video: anu.result, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send video`))
break
case 'cecan':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'amongus': case 'amogus': case 'amongsus':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/amongus?apikey=${lolkey}&text=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cecan2':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/cecan?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'kpop':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/kpop?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
...
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/random/bocil?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/random/cosplay?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'wallnime': 
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/random/hug?apikey=${lolkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'certyt': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Example : ${prefix}${command} Kelly`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/bucinserti?apikey=${lolkey}&name=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'certpacar': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!text) return reply(`Example : ${prefix}${command} Kelly|Alok`)
reply(mess.wait)
var mon = args.join(' ')
var q1 = mon.split("|")[0]
var q2 = mon.split("|")[1]
anu = await getBuffer(`https://api.lolhuman.xyz/api/pacarserti?apikey=${lolkey}&name1=${q1}&name2=${q2}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'certolol': 
if (isBan) return reply(mess.ban)	 			
...
if (!text) return reply(`Example : ${prefix}${command} Kelly`)
reply(mess.wait)
anu = await getBuffer(`https://api.lolhuman.xyz/api/toloserti?apikey=${lolkey}&name=${text}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'logogirl': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/nsfw/ero?apikey=elaina`)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/yuri?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak})
break
   case 'spank':
      if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
                ...
                buf = await getBuffer(`https://cililitan.herokuapp.com/api/${command}?url=${anu}`)
...
if (isBanChat) return reply(mess.banChat)
                ...
                media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
                anu = await TelegraPh(media)
                buf = await getBuffer(`https://cililitan.herokuapp.com/api/gay?url=${anu}`)
                XeonBotInc.sendMessage(m.chat, { image: buf, caption: `Made by ${botname}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
                }
                break
case 'bugsw': {
...
if (isQuotedImage) {
XeonBotInc.sendMessage(m.chat, { image: hasil, caption: `${bugsw}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
} else if (isQuotedVideo) {
XeonBotInc.sendMessage(m.chat, { video: hasil, caption: `${bugsw}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
}
}
break
case 'readqr': {
 if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!/image/.test(mime)) return reply(`Where's QR CODE?`)
media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
anu = await TelegraPh(media)
bacaqr = await fetchJson(`https://api.lolhuman.xyz/api/read-qr?apikey=${lolkey}&img=${anu}`)
let hasil = await getBuffer(bacaqr)
if (isQuotedImage) {
XeonBotInc.sendMessage(m.chat, { image: hasil, caption: mess.success }, { quoted: fkontak}).catch ((err) => reply(mess.error))
}
}
break
case 'jadivirtext1': {
...
hasil = await getBuffer(anu)
if (isQuotedImage) {
XeonBotInc.sendMessage(m.chat, { image: hasil, caption: `${virtex1}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
} else if (isQuotedVideo) {
XeonBotInc.sendMessage(m.chat, { video: hasil, caption: `${virtex1}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
}
}
break
case 'jadivirtext2': {
...
hasil = await getBuffer(anu)
if (isQuotedImage) {
XeonBotInc.sendMessage(m.chat, { image: hasil, caption: `${buttonkal}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
} else if (isQuotedVideo) {
XeonBotInc.sendMessage(m.chat, { video: hasil, caption: `${buttonkal}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
}
}
break
case 'deleteeffect': {
...
if (isBanChat) return reply(mess.banChat)
                ...
                media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
                anu = await TelegraPh(media)
                buf = await getBuffer(`https://cililitan.herokuapp.com/api/delete?url=${anu}`)
                XeonBotInc.sendMessage(m.chat, { image: buf, caption: `Made by ${botname}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
                }
                break
case 'framed': {
...
if (isBanChat) return reply(mess.banChat)
                ...
                media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
                anu = await TelegraPh(media)
                buf = await getBuffer(`https://cililitan.herokuapp.com/api/fotojatoh?url=${anu}`)
                XeonBotInc.sendMessage(m.chat, { image: buf, caption: `Made by ${botname}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
                }
                break
...
if (isBanChat) return reply(mess.banChat)
                ...
                media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)                
                anu = await TelegraPh(media)
                buf = await getBuffer(`https://cililitan.herokuapp.com/api/beautiful?url=${anu}`)
                XeonBotInc.sendMessage(m.chat, { image: buf, caption: `Made by ${botname}` }, { quoted: fkontak}).catch ((err) => reply(mess.error))
                }
                break
            case 'readmore': {
...
if (isBanChat) return reply(mess.banChat)
        ...
        if (/image/.test(mime)) {
anu = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
		XeonBotInc.sendMessage(m.chat, { image: {url: anu}, caption: `${bugsw}`, viewOnce : true}, { quoted: fkontak}).catch ((err) => reply(mess.error))
        } else if (/video/.test(mime)) {
        anu = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
		XeonBotInc.sendMessage(m.chat, { video: {url: anu}, caption: `${bugsw}`,viewOnce : true},  { quoted: fkontak}).catch ((err) => reply(mess.error))
        }
		}
        break
        case 'tinyurl': {
...
break
case 'dosa1':
dosa = (`*MINING DOSA KAK?*\nLink Download \n\nhttps://www.mediafire.com/file/h2nygxbyb6n9cyo/VID-20210107-WA1468.mp4/file`)
dosak = fs.readFileSync('./XeonMedia/image/dosa.jpg')
XeonBotInc.sendImage(m.chat, dosak, dosa, fkontak)
break
case 'dosa2':
...
if (!isCreator) return replay(mess.owner)
if (XeonBotInc.autoreact) {
XeonBotInc.autoreact = false
m.reply('auto react is now disabled')
} else if (!XeonBotInc.autoreact) {
XeonBotInc.autoreact = true
m.reply('auto react is now active')
}
} 
break
//case 'daftar':
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(`Chat Owner Untuk Detail Selanjutnya, Pastikan Mempunyai 2 HP.`)
}
break
case 'listjadibot':
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/hestia?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'tsunade':
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://rest-api-elaina.herokuapp.com/api/wallpaper/cogan?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kurumi':
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
                ...
                images = n[Math.floor(Math.random() * n.length)].url
                        XeonBotInc.sendImage(m.chat, images, mess.success, m)
                })
                }
                break
case 'loli-waifu':
...
if (isBanChat) return reply(mess.banChat)
	...
	gambar = fs.readFileSync('./XeonMedia/image/kisahnabi.jpg')
	iyain = await fetchJson(`https://rest-api-elaina.herokuapp.com/api/muslim/kisahnabi?nabi=${q}&apikey=elaina`)
	katanya = iyain.result
	nama = katanya.name
	wafat = katanya.wafat_usia
	tahun = katanya.kelahiran
	tempat = katanya.singgah
	kisah = katanya.kisah
...
not = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${text}?apikey=${lolkey}`)
njy = not.result
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!text) throw `Contoh penggunaan:\n${prefix + command} jessnolimit`
not = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${text}?apikey=${lolkey}`)
njy = not.result
gambar = await getBuffer(njy.photo_profile)
capk = (`「 *Stalk Instagram* 」
*Username* : ${njy.username}
*Fullname* : ${njy.fullname}
*Posts* : ${njy.posts}
*Followers* : ${njy.followers}
*Following* : ${njy.following}
*Bio* : ${njy.bio}`)
XeonBotInc.sendImage(m.chat, gambar, capk, fkontak)
break
case 'niatsalat': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!text) throw `Contoh penggunaan:\n${prefix + command} subuh`
not = await fetchJson(`https://api.lolhuman.xyz/api/niatsholat/${text}?apikey=${lolkey}`)
njy = not.result
replay(`「 *Niat Sholat* 」
*Nama* : ${njy.name}
*Al-Qur'an* : ${njy.ar}
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
var funne = await getBuffer(`https://api.lolhuman.xyz/api/meme/darkjoke?apikey=${lolkey}`)
teks = "yhaha hayyuk"
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
let sexx = await fetchJson(`https://zenzapis.xyz/randomtext/cersex2?apikey=${zenzkey}`)
cers = sexx.result
jud = cers.Judul
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
let pen = await fetchJson(`https://api.lolhuman.xyz/api/cerpen?apikey=${lolkey}`)
cer = pen.result
jud = cer.Judul
pen = cer.Penulis
sum = cer.sumber
...
if (isBan) return reply(mess.ban)
if (isBanChat) return reply(mess.banChat)
if (!text) return reply(`Apikeymu mana?`)
yoii = await fetchJson(`https://api.lolhuman.xyz/api/checkapikey?apikey=${text}`)
yh = yoii.result
reply(`「 *LoLHuman* 」
*Username* : ${yh.username}
*Requests* : ${yh.requests} 
*Today* : ${yh.today}
*Type* : ${yh.account_type}
*Expired* : ${yh.expired}`)
break
case 'zenzkey': {
...
let jad = await fetchJson(`https://rest-api-elaina.herokuapp.com/api/music/joox?query=${q}&apikey=elaina`)
jadres = jad.result
song = jadres.lagu
album = jadres.album
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return reply(`Where's the call link?`)
yox = (`${q}\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n${philips}\n\n\n\n\n\n\n\n\n\n${virtex1}\n\n\n\n\n\n\n\n\n\n\n\n\n\n${bugsw}`)
XeonBotInc.sendMessage(m.chat, { image: virgamm, caption: yox }, { quoted: doc })
break
case 'virtext2': {
		  if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
📌 Repo Updated + Event Berjalan

Cek Repo
https://github.com/RavensVenix/elainav6

Elaina Rest-APIs
https://rest-api-elaina.herokuapp.com
...
break
	case 'nekosearch': case 'nekopoi': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!args.join(" ")) return replay(`Example : ${prefix + command} stay jb`)
if (!text) return reply(`What do you want to search?`)
reply(mess.wait)
neko = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=${lolkey}&query=${text}`)
mwek = neko.result
var neq = JSON.parse(JSON.stringify(mwek))
var mq =  neq[Math.floor(Math.random() * neq.length)]
capt = (`Title : ${mq.title}
Thumbnail : ${mq.thumbnail}`)
XeonBotInc.sendMessage(m.chat, { image: { url: mq.thumbnail },  caption: capt }, { quoted: fkontak })
}
break
case 'xnxx': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return replay(`Example : ${prefix + command} japan`)
yts = (`https://rest-api-elaina.herokuapp.com/api/downloader/xnxx?query=${q}&apikey=elaina`)
res = await fetchJson(yts)
okay = res.result
yaaa = okay[Math.floor(Math.random() * okay.length)]
teks = (`Title : ${yaaa.tittle}
Info : ${yaaa.info}
Link : ${yaaa.link}`)
XeonBotInc.sendMessage(m.chat, teks, fkontak)
}
break
case 'google': {
   if (isBan) return reply(mess.ban)	 			
...
reply(mess.wait)
require('./lib/tiktok').Tiktok(q).then( data => {
XeonBotInc.sendMessage(m.chat, { video: data.nowm, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `${bugsw}` }, { quoted:fkontak })
})
break
case 'tktokaudio':
case 'ttaud':
...
if (isBanChat) return reply(mess.banChat)
	...
	reply(mess.wait)
	katanya = await fetchJson(`https://api.lolhuman.xyz/api/ytplay?apikey=${lolkey}&query=${q}`)
	nj = katanya.result
	nk = nj.info
	mk = nj.audio
	uk = nj.video
	thumbnaill = await getBuffer(nk.thumbnail)
	caption = (`
╭━═════════════━•
│${sp}➳ Title : ${nk.title}
│${sp}➳ ID : ${nk.id}
│${sp}➳ Likes : ${nk.like}
│${sp}➳ Dislikes : ${nk.dislike}
│${sp}➳ Uploader : ${nk.uploader}
│${sp}➳ Duration : ${nk.duration}
│${sp}➳ Viewers : ${nk.view}
│${sp}➳ Upload At : ${nk.published}
│${sp}➳ Channel : ${nk.channel}
│${sp}➳ Audio : ${mk.link}
│${sp}➳ Bitrate : ${mk.bitrate}
│${sp}➳ Size : ${mk.size}
│${sp}➳ Video : ${mk.link}
│${sp}➳ Resolution : ${mk.resolution}
│${sp}➳ Type : ${mk.type}
│${sp}➳ Size : ${mk.size}
╰━═════════════━•`)
...
const mekik4 = fs.readFileSync('./XeonMedia/image/anim3.jpg')
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
                `).trim()
                XeonBotInc.sendMessage(m.chat, { image: mekik4 , caption: respon }, { quoted: fkontak })
				await sleep(1500)
...
const mekik = fs.readFileSync('./XeonMedia/image/anim2.jpg')
...
${global.rules}`)
  XeonBotInc.sendMessage(m.chat, { image: mekik , caption: kocak }, { quoted: fkontak })
  await sleep(1000)
...
const mekik2 = fs.readFileSync('./XeonMedia/image/anim.jpg')
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
yabai = await fetchJson(`https://api.lolhuman.xyz/api/countdown/1/1/2023?apikey=${lolkey}`)
kens = yabai.result
kocak2 = (`
┌─────✪ 「 HELLO ${m.pushName} 」
...
│${sp} ${prefix}hidetag
│${sp} ${prefix}tagall
│${sp} ${prefix}antilinkgc
│${sp} ${prefix}antilinktg
│${sp} ${prefix}antilinktt
│${sp} ${prefix}antilinkytch
│${sp} ${prefix}antilinkytvid
│${sp} ${prefix}antilinkig
│${sp} ${prefix}antilinkfb
│${sp} ${prefix}antilinktwit
│${sp} ${prefix}antilinkall
│${sp} ${prefix}antivirus
│${sp} ${prefix}antitoxic
│${sp} ${prefix}antiwame
│${sp} ${prefix}autoreply
...
│${sp} ${prefix}xytroli
│${sp} ${prefix}xytrolito
│${sp} ${prefix}xytrolito2
│${sp} ${prefix}xytroli2
│${sp} ${prefix}xycatalog
│${sp} ${prefix}xycatalog2
│${sp} ${prefix}xybugpc
│${sp} ${prefix}attack
│${sp} ${prefix}attackto
│${sp} ${prefix}xybugloc
...
│${sp} ${prefix}bugtiktok
│${sp} ${prefix}bugsw
│${sp} ${prefix}jadivirtext1
│${sp} ${prefix}jadivirtext2
│${sp} ${prefix}buginvite Pc
│${sp} ${prefix}buglokas
│${sp} ${prefix}bugstik
│${sp} ${prefix}buttonampas
│${sp} ${prefix}troli
│${sp} ${prefix}troli2
│${sp} ${prefix}spam
│${sp} ${prefix}bugtag
...
│${sp} ${prefix}facepalm
│${sp} ${prefix}certbucin
│${sp} ${prefix}hartatahta
│${sp} ${prefix}customht
│${sp} ${prefix}kannagen
│${sp} ${prefix}ohno
│${sp} ${prefix}ktp
│${sp} ${prefix}fakecommentyt
│${sp} ${prefix}facedetect
│${sp} ${prefix}genderdetect
│${sp} ${prefix}changemymind
│${sp} ${prefix}memeheart
│${sp} ${prefix}memetombol
│${sp} ${prefix}memekertas
│${sp} ${prefix}ramadhan
│${sp} ${prefix}qrcode
│${sp} ${prefix}readqr
│${sp} ${prefix}candy
...
│${sp} ${prefix}playmp4
│${sp} ${prefix}playmp3
│${sp} ${prefix}tiktokaudio
│${sp} ${prefix}tiktoknowm
│${sp} ${prefix}mediafire
│${sp} ${prefix}gitclone
│${sp} ${prefix}soundcloud
│${sp} ${prefix}zippyshare
└─────✪
┌─────✪ 「 SEARCH 」	
│${sp} ${prefix}searchgc
│${sp} ${prefix}nekopoi
...
│${sp} ${prefix}simp
│${sp} ${prefix}nenen
│${sp} ${prefix}beautifulcheck
│${sp} ${prefix}awesomecheck
│${sp} ${prefix}prettycheck
│${sp} ${prefix}lesbiancheck
│${sp} ${prefix}gaycheck
│${sp} ${prefix}cutecheck
│${sp} ${prefix}uglycheck
│${sp} ${prefix}hornycheck
│${sp} ${prefix}charactercheck
│${sp} ${prefix}lovelycheck
│${sp} ${prefix}couple
...
│For helping me adding all of this features
└─────────────┈ ⳹`)
XeonBotInc.sendMessage(m.chat, { image: mekik2 , caption: kocak2 }, { quoted: fkontak })
await sleep(1000)
...
│${sp} ${prefix}hidetag
│${sp} ${prefix}tagall
│${sp} ${prefix}autosticker
│${sp} ${prefix}autostickerpc
│${sp} ${prefix}leveling
│${sp} ${prefix}antilinkgc
│${sp} ${prefix}antilinktg
│${sp} ${prefix}antilinktt
