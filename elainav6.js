...
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://elaina-rest-api.herokuapp.com/api/maker/attp?text=${text}&apikey=elaina`, 'Xeon', 'Op', m, {asSticker: true}).catch((err) => reply(mess.error))
         }
         break
case 'ttp': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://elaina-rest-api.herokuapp.com/api/maker/ttp?text=${text}&apikey=elaina`, 'A L Y A', 'B O T M D', m, {asSticker: true})
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/sagiri?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'ayuzawa': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/ayuzawa?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'kaneki': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/akira?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'sakura': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/sakura?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'satanic': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/satanic?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'emojipng': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await fetchJson(`https://elaina-rest-api.herokuapp.com/api/maker/emoji2png?text=${q}&apikey=elaina`)
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://zenzapis.xyz/randomasupan/asupantiktok?apikey=${zenzkey}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => reply(`Sorry, Failed to send image`))
break
case 'cecan':
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/random/bocil?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/yuri?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak})
break
   case 'spank':
      if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
reply(mess.wait)
anu = await getBuffer(`https://elaina-rest-api.herokuapp.com/api/wallpaper/hestia?apikey=elaina`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Sorry, Failed to send image'))
break
case 'tsunade':
if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
	...
	iyain = await fetchJson(`https://elaina-rest-api.herokuapp.com/api/muslim/kisahnabi?nabi=muhammad&apikey=elaina`)
...
Elaina Rest-APIs
https://elaina-rest-api.herokuapp.com
...
yts = (`https://elaina-rest-api.herokuapp.com/api/downloader/xnxx?query=${q}&apikey=elaina`)
...
XeonBotInc.sendMessage(m.chat, caption, { quoted: fkontak })
})
}
break
...
if (isBanChat) return reply(mess.banChat)
	...
	katanya = await fetchJson(`https://elaina-rest-api.herokuapp.com/api/yt/playmp3?query=surender&apikey=elaina`)
	thumbnaill = await getBuffer(katanya.thumb)
	caption = (`
╭━═════════════━•
│${sp}➳ Title : ${katanya.title}
│${sp}➳ Audio : ${katanya.url}
│${sp}➳ Viewers : ${katanya.views}
│${sp}➳ Upload At : ${katanya.published}
...
if (isBanChat) return reply(mess.banChat)
	if (!q) return reply('Wheres The Link?')
		if (!text) throw `Example : ${prefix + command} nightcore wasted`
	katanya = await fetchJson(`https://elaina-rest-api.herokuapp.com/api/yt/playmp4?query=surender&apikey=elaina`)
	thumbnaill = await getBuffer(katanya.thumb)
	caption = (`
╭━═════════════━•
│${sp}➳ Title : ${katanya.title}
...
╠${sp} ${prefix}bugsw [ Send Image ]
╠${sp} ${prefix}jadivirtext1 [ Send Image / Video ]
╠${sp} ${prefix}jadivirtext2 [ Send Image / Video ]
...
╠${sp} ${prefix}playmp4 [link]
╠${sp} ${prefix}playmp3 [link]
